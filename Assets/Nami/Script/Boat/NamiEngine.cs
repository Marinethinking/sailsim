...
namespace Nami
{
    public class NamiEngine : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            engineSoundPitch = VelocityMag * 0.1f;
            engineSound.pitch = engineSoundPitch; // use some magice numbers to control the pitch of the engine sound
